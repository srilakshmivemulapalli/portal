        ...
        function getHeaderText() {
            ...
            if (isMultiple) {
                ...
                if(angular.isString(modelCtrl.$modelValue)){
                    ...
                    for(var i = 0; i < scope.items.length; i++) {
                        if(scope.items[i].model === modelCtrl.$modelValue) {
                        var header = scope.items[i].label;
                        }
                    }
                   scope.header =  parsedResult.viewMapper(local)|| header;
                }
            }
        }
